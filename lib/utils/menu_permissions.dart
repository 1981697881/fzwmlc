...
import 'package:fzwmlc/views/production/warehousing_detail.dart';
import 'package:fzwmlc/views/production/warehousing_page.dart';
import 'package:fzwmlc/views/purchase/purchase_warehousing_detail.dart';
import 'package:fzwmlc/views/purchase/purchase_warehousing_page.dart';
import 'package:fzwmlc/views/sale/retrieval_detail.dart';
import 'package:fzwmlc/views/sale/retrieval_page.dart';
import 'package:fzwmlc/views/sale/return_goods_detail.dart';
import 'package:fzwmlc/views/sale/return_goods_page.dart';
import 'package:fzwmlc/views/stock/Inventory_detail.dart';
import 'package:fzwmlc/views/stock/Inventory_page.dart';
import 'package:fzwmlc/views/stock/ex_warehouse_detail.dart';
import 'package:fzwmlc/views/stock/ex_warehouse_page.dart';
import 'package:fzwmlc/views/stock/grounding_page.dart';
import 'package:fzwmlc/views/stock/other_warehousing_detail.dart';
import 'package:fzwmlc/views/stock/other_warehousing_page.dart';
import 'package:fzwmlc/views/stock/stock_page.dart';
import 'package:fzwmlc/views/stock/undercarriage_page.dart';
import 'package:fzwmlc/views/workshop/dispatch_detail.dart';
import 'package:fzwmlc/views/workshop/dispatch_page.dart';
import 'package:fzwmlc/views/workshop/report_detail.dart';
import 'package:fzwmlc/views/workshop/report_page.dart';
