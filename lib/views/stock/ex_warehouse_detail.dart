          ...
          if (element[0]['value']['value'] == scanCode[0]) {
            if (element[0]['value']['barcode'].indexOf(_code) == -1) {
              ...
              element[3]['value']['label'] =
                  (double.parse(element[3]['value']['label']) + 1).toString();
  ...
  saveOrder() async {
    if (this.hobby.length > 0) {
      ...
      if (res['Result']['ResponseStatus']['IsSuccess']) {
        ...
        //提交
        HandlerOrder.orderHandler(context, submitMap, 1, "STK_MisDelivery",
            ...
            HandlerOrder.orderHandler(context, submitMap, 1, "STK_MisDelivery",
              ...
              if (auditResult) {
                ...
                HandlerOrder.orderHandler(context, submitMap, 0,
                        "STK_MisDelivery", SubmitEntity.unAudit(submitMap))
                    .then((unAuditResult) {
                  if (unAuditResult) {
                    this.isSubmit = false;
                  }
