...
import 'package:fzwmlc/views/production/replenishment_detail.dart';
import 'package:qrscan/qrscan.dart' as scanner;
import 'package:shared_preferences/shared_preferences.dart';

class ReplenishmentPage extends StatefulWidget {
  ReplenishmentPage({Key ?key}) : super(key: key);
...
class _ReplenishmentPageState extends State<ReplenishmentPage> {
  ...
  getOrderList() async {
    ...
    "FStatus in (4) and FNoStockInQty>0 and FDate>= '$startDate' and FDate <= '$endDate' and FPrdOrgId.FNumber="+deptData[1];
    var scanCode = keyWord.split(",");
    if(this.keyWord != ''){
      userMap['FilterString'] =
          "FSaleOrderNo='"+scanCode[0]+"' and FStatus in (4) and FNoStockInQty>0 and FDate>= '$startDate' and FDate <= '$endDate' and FPrdOrgId.FNumber="+deptData[1];
    }
